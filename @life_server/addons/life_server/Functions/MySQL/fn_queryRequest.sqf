...
_query = switch(_side) do {
	...
	case east: {format["SELECT playerid, name, cash, bankacc, adminlevel, donatorlvl, opfor_licenses, armylevel, opfor_gear blacklist FROM players WHERE playerid='%1'",_uid];};
};
