...
switch (_side) do {
	...
	case east: {_query = format["UPDATE players SET name='%1', cash='%2', bankacc='%3', opfor_gear='%4', opfor_licenses='%5' WHERE playerid='%6'",_name,_cash,_bank,_gear,_licenses,_uid];};
};
