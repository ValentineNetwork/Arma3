...
if(isNil "_loadout") exitWith {[] call life_fnc_opforDefault;}; //Slot data doesn't exist
if(count _loadout == 0) exitWith {[] call life_fnc_opforDefault;}; //Slot data doesn't exist
